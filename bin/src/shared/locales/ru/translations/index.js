...
exports.default = __assign(__assign(__assign(__assign(__assign(__assign(__assign(__assign(__assign(__assign(__assign(__assign(__assign(__assign({}, actions_1.default), dashboard_1.default), sex_1.default), incidents_1.default), network_status_1.default), labs_1.default), states_1.default), scheduling_1.default), patient_1.default), patients_1.default), settings_1.default), medications_1.default), blood_type_1.default), imagings_1.default);
