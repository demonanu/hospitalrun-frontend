...
exports.default = __assign(__assign(__assign(__assign(__assign(__assign({}, actions_1.default), dashboard_1.default), patient_1.default), patients_1.default), settings_1.default), medications_1.default);
